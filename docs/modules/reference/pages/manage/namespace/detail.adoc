...
* ❹ *Namespace Actions*: A menu for essential actions like creating new xref:docs::how-to-guides/Configure Application.adoc[applications], xref:ROOT:how-to-guides/application/Logging.adoc[searching logs], or deleting the Namespace
