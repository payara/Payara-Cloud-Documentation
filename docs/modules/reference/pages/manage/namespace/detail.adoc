...
image::manage/namespace/namespace-1-overview.png[Namespace Detail Screen,100%, opts=interactive, window="_blank", link="{imagesdir}/manage/namespace/namespace-1-overview.png"]
