...
image::manage/namespace/namespace-1-list-page.png[window="_blank", link="{imagesdir}/manage/namespace/namespace-1-list-page.png"]
...
image::manage/namespace/namespace-2-create.png[window="_blank", link="{imagesdir}/manage/namespace/namespace-2-create.png"]
