...
.Namespace list
image::manage/application/application-4-namespace-list.png[]

*View Applications*: Each Namespace presents a list of its associated applications.
...
* ❹ Application name
* ❺ Application status. An application can have any of the status PENDING, CONFIGURED, DEPLOYED at any point in time
