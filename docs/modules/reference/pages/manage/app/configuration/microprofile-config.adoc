...
image::manage/application/application-14-mp-config.png[window="_blank", link="{imagesdir}/manage/application/application-14-mp-config.png"]
...
image::manage/application/application-19-add-config-key.png[window="_blank", link="{imagesdir}/manage/application/application-19-add-config-key.png"]
...
.Add MicroProfile Config Key
image::manage/application/application-20-set-prop-value.png[window="_blank", link="{imagesdir}/manage/application/application-20-set-prop-value.png"]
...
image::manage/application/application-15-restrict-fields.png[window="_blank", link="{imagesdir}/manage/application/application-15-restrict-fields.png"]
...
image::manage/application/application-16-restrected-fields.png[window="_blank", link="{imagesdir}/manage/application/application-16-restrected-fields.png"]
