...
image::billing/subscription/user-subscription/signup.svg[Screenshot of signup screen,100%,opts=interactive, window="_blank", link="{imagesdir}/billing/subscription/user-subscription/signup.png"]
...
image::billing/signup/login-screen.png[window="_blank", link="{imagesdir}/billing/signup/login-screen.png"]

Enter your username or email address on the subsequent screen:

.Password Reset Screen
image::billing/signup/pw-reset-01.png[, window="_blank", link="{imagesdir}/billing/signup/pw-reset-01.png"]

After clicking btn:[Continue],  an email will be sent to the corresponding user:

.Password Reset Confirmation
image::billing/signup/pw-reset-02.png[window="_blank", link="{imagesdir}/billing/signup/pw-reset-02.png"]

The email looks like this:

.Password Reset Email
image::billing/signup/pw-reset-03.png[window="_blank", link="{imagesdir}/billing/signup/pw-reset-03.png"]

This email guides you to the password reset page:

.Password Reset Page
image::billing/signup/pw-reset-04.png[window="_blank", link="{imagesdir}/billing/signup/pw-reset-04.png"]
...
.GitHub Login Prompt
image::billing/signup/github-01.png[Github Login Page, window="_blank", link="{imagesdir}/billing/signup/github-01.png"]
...
image::billing/signup/github-02.png[Github Authorisation Page, window="_blank", link="{imagesdir}/billing/signup/github-02.png"]
...
.Google Login Prompt
image::billing/signup/google-01.png[window="_blank", link="{imagesdir}/billing/signup/google-01.png"]
