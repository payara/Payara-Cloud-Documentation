...
This will redirect you to the link:subscription-plan.adoc[Signup page], where you’ll be prompted to enter new company details and authorize a new payment method.
