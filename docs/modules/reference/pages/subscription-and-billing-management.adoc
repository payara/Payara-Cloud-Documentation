...
In {productName}, a subscription serves as the fundamental billing unit, encompassing the resources and access levels you've selected for your cloud deployment needs.
...
The subscription model simplifies the billing process, providing a clear and aggregated view of your {productName} usage and costs.

== Choosing a Subscription Plan

{productName} offers three subscription plans tailored to different needs, each with its own set of features and resource allocations. The available plans are:
...
The specific resource allocations and pricing for each plan can be found on the {productName} website or by contacting the Payara sales team.

== Managing Subscriptions

You can view and manage your existing subscriptions through the Billing Management section in {productName}.
...
* *Cancelling Subscription*: Terminate your subscription if you no longer require {productName} services.

=== Subscription Plan Changes (Upgrade/Downgrade)

You can upgrade or downgrade your subscription plan at any time through Billing management section in {productName}.

{productName} will not allow subscription downgrade if you have exceeded the vCPU quota.
...
* *Subscription Downgrade*: The downgrade will take effect at the end of the current billing cycle, and you can cancel the downgrade request before the end of the billing cycle through Billing Management section in {productName}.

==== Subscription Plan Change Email Notification

{productName} will send email notifications to Billing Managers for any subscription plan changes activity.
...
{productName} operates on a 30-day billing cycle.
...
=== Payment Methods
{productName} accepts both credit and debit card payments.


{productName}'s subscription and billing management system offers transparency and flexibility, allowing you to tailor your cloud deployment costs to your specific requirements and usage patterns.
...
In case of payment failure, {productName} will keep your current subscription active and will try to process your payment within 24 hours. If the payment is not successful, the subscription upgrade will be voided.
