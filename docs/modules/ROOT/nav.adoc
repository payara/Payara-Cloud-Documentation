...
*** xref:getting-started/paas/signup.adoc[Signing up]
*** xref:getting-started/paas/login.adoc[Log into Your Account]
endif::[]
...
*** xref:user-guides/common/application/Deploying an Application.adoc#deploying-pending-applications[Deploy Pending Application]
*** xref:user-guides/common/application/Configure Application.adoc[Configure Application]
*** xref:user-guides/common/application/Configure Application.adoc#database-configuration[Configure Datasource]
...
*** xref:getting-started/paas/cancel-subscription.adoc[How To Cancel Subscription]
...
** Advanced Features
ifeval::["{page-site-edition}" == "qube"]
*** xref:user-guides/common/application/integrations.adoc[Third Party Integrations]
endif::[]
...
*** xref:user-guides/common/aws-region-help.adoc[AWS Region Support (Beta)]
ifeval::["{page-site-edition}" == "qube"]
endif::[]
