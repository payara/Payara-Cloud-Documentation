...
.Manage Users Screen
image::how-to-guides/billing/user-subscription/manage-users.svg[Screenshot of Manage Users screen,100%,opts=interactive, link="{imagesdir}/how-to-guides/billing/user-subscription/manage-users.png", window="_blank"]
...
Details of `Roles` can be found here: xref:reference:billing/subscription/user-subscription.adoc[]
...
image::how-to-guides/billing/user-subscription/add.png[Screenshot of Add User page, link="{imagesdir}/how-to-guides/billing/user-subscription/add.png", window="_blank"]
...
image::how-to-guides/billing/user-subscription/email.png[Screenshot of invitation email,65%,link="{imagesdir}/how-to-guides/billing/user-subscription/email.png", window="_blank"]

Following the link btn:[Signup to Payara Cloud] will lead to the signup prompt.

image::how-to-guides/billing/user-subscription/signup.svg[Screenshot of signup screen,100%,opts=interactive, link="{imagesdir}/how-to-guides/billing/user-subscription/signup.png", window="_blank"]
...
image::how-to-guides/billing/user-subscription/accepted.png[Screenshot of acceptance screen, link="{imagesdir}/how-to-guides/billing/user-subscription/accepted.png", window="_blank"]
...
image::how-to-guides/billing/user-subscription/copy-link.png[Screenshot of Copy Invitation Link, link="{imagesdir}/how-to-guides/billing/user-subscription/copy-link.png", window="_blank"]

=== Editing a User

Click btn:[Edit User] to view the properties of the respective user of this subscription.

image::how-to-guides/billing/user-subscription/edit.png[Screenshot of Edit User screen, link="{imagesdir}/how-to-guides/billing/user-subscription/edit.png", window="_blank"]
...
image::how-to-guides/billing/user-subscription/remove.png[Screenshot of Remove User screen, link="{imagesdir}/how-to-guides/billing/user-subscription/remove.png", window="_blank"]
