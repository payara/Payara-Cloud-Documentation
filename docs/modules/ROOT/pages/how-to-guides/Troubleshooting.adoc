...
2. **Check DNS Configuration**: Verify that your DNS settings are correctly configured in your domain provider's dashboard. Please refer to xref:how-to-guides/How to Use Custom Domains.adoc[How to Use Custom Domains] to confirm you have entered the right settings for the domain.
