...
image::/how-to-guides/application/billing/billing-plan-1.png[alt="Payara Cloud Plans", window="_blank", link="{imagesdir}/how-to-guides/application/billing/billing-plan-1.png"]
