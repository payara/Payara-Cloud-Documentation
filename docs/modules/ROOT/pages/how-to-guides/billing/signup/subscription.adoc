...
image::/how-to-guides/application/billing/new-product-line-up.png[alt="Payara Cloud Plans", window="_blank", link="{imagesdir}/how-to-guides/application/billing/new-product-line-up.png"]
