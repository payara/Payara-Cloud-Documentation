...
To get started, head over to the https://login.payara.cloud/u/signup[signup page] and fill in the signup form.
...
image::new-signup5.png[Payara Cloud Subscription Confirmation, text Description automatically generated,width=672,height=361, link="{imagesdir}/new-signup-5.png", window="_blank"]
