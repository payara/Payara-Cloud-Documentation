...
To initiate your journey with Payara Cloud, securing access to a Payara Cloud Subscription is the initial step. This can be effortlessly achieved by proceeding with the xref:getting-started/paas/signup.adoc[Signup]  process to create a trial account.
