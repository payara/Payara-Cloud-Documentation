...
=== Free Trial
For new users, the best way to begin is with our 15-day free trial. A detailed guide to get you started is available here: xref:getting-started/paas/Signup {productName}.adoc[].

=== Existing Users
If you're already using {productName}, you can easily create additional subscriptions by either link:additional.adoc[reusing existing invoicing data] or link:additional.adoc[providing new invoicing data].
...
A subscription can be cancelled at any time by following the procedure listed here: xref:getting-started/paas/Cancel {productName}.adoc[].
