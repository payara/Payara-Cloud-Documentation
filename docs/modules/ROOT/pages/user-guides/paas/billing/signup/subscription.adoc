...
To use {productName}, you will need to sign up for a subscription.
A {productName} subscription plan represents the billable unit for your usage of the {productName} service.

You can choose from a variety of available {productName} plans tailored to your needs.
...
If you are new, you can start with the xref:getting-started/paas/Signup Payara Cloud.adoc[{productName} Trial].
...
image::how-to-guides/application/billing/new-product-line-up.png[alt="{productName} Subscription Plans", window="_blank", link="{imagesdir}/how-to-guides/application/billing/new-product-line-up.png"]
...
Agree to the {productName}'s Terms and Conditions.
...
You'll then be directed to the {productName} Application Management console.
...
.Manage Subscription
image::how-to-guides/application/billing/billing-plan-2.png[alt="{productName} Plans", window="_blank", link="{imagesdir}/how-to-guides/application/billing/billing-plan-2.png"]
...
=== Set Usage Alerts
To have better visibility and control over your usage of {productName}, you can set usage alerts for your subscriptions.
