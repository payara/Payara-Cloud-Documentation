...
A detailed guide to get you started is available xref:docs:ROOT:getting-started/paas/signup.adoc[here].
...
A subscription can be canceled at any time by the following steps outlined in xref:docs:ROOT:getting-started/paas/cancel-subscription.adoc[cancel subscription].
