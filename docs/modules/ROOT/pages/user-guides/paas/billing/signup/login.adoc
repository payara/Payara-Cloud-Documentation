...
{productName} streamlines user authentication with three convenient options:
...
Upon visiting the {productName} Billing Management console, you're greeted with a registration screen:

.{productName} Signup Screen
...
For first-time logins, GitHub will request authorization for {productName} to access your account:
