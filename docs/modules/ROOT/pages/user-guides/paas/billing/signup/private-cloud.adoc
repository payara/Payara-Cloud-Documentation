...
Deploy {productName} applications in your own Azure infrastructure while maintaining full control over your cloud resources and costs.
...
* {productName} runtime fee: $0.12 per vCPU-hour (minimum 0.25 core)
...
.. Visit https://billing.payara.cloud/cmr/signup[{productName} Signup,window=_blank]
+
...
.. Search for https://portal.azure.com/#create/payara.cloud-cmr[{productName} Customer Managed Region,window=_blank]
...
Connection String:: Value copied from {productName}
...
* Check https://docs.payara.fish/cloud/docs/Overview.html[{productName} documentation]
