...
Following the link btn:[Signup to {productName}] will lead to the signup prompt.
...
Specifically, {productName} Support will never ask you for the invitation link.
