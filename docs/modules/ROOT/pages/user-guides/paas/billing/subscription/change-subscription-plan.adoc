...
Select the new plan from the list of available plans. 
{productName} offers both upgrade and downgrade options for your subscription plans. Click "Confirm Subscription Choice" to proceed.
