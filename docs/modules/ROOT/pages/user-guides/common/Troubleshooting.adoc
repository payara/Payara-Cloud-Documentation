...
2. **Check SSL Status**: You can use online tools such as https://crt.sh or https://certobserver.com/ct-search to check if LetsEncrypt is done generating SSL certificate for your custom domain.
