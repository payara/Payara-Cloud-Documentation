...
{productName} organizes applications within distinct Namespaces.
...
.Namespace list
image::how-to-guides/application/application-4-namespace-list.png[window="_blank", link="{imagesdir}/how-to-guides/application/application-4-namespace-list.png"]

*View Applications*: Each Namespace represents a list of its associated applications.

.Namespace with application list
image::how-to-guides/application/applications-1-namespace-detail-page.png[Namespace Detail Screen,100%, opts=interactive, window="_blank", link="{imagesdir}/how-to-guides/application/applications-1-namespace-detail-page.png"]
...
This action will direct you to the xref:user-guides/common/application/detail.adoc[application detail page].
