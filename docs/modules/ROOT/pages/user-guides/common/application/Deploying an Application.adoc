...
NOTE: For Quarkus applications, see xref:user-guides/common/application/Quarkus Applications.adoc[Building Quarkus Applications] for instructions on preparing your application with the Payara Qube Quarkus extension.
...
* *Quarkus applications*: Upload a ZIP file (see  xref:user-guides/common/application/Quarkus Applications.adoc[Building Quarkus Applications] build instructions.)
