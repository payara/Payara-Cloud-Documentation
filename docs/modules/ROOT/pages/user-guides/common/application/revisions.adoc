...
{productName} uses revisions for application version management.
...
Each revision maintains its unique xref:user-guides/common/application/Configure Application.adoc[configurations], distinct from others.
