...
[checklist]
* ❶ Binary Upload Button: Click to bring up the file upload dialog to pick an application binary (.WAR file for Jakarta EE applications, .JAR file for Spring Boot applications, or .ZIP file for Quarkus applications).
