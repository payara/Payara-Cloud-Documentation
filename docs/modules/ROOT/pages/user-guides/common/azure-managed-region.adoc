...
In essence, this service enables you to use {productName}'s managed Jakarta EE capabilities while maintaining your applications within your own Azure infrastructure.
