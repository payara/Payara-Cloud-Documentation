...
<<Command Reference>> then lists all options and sub-commands supported by the client.
...
// === Getting started
// downloading and instlaling pcl
...
[.text-center]
image:images/login-01-enter-code.png[width=320]

After that a confirmation page is displayed:

[.text-center]
image:images/login-02-confirmation.png[width=320]
