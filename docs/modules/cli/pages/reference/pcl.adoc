...
== Commands
xref:docs:cli:reference/pcl-login.adoc[*login*]::
  Log in to Payara Cloud instance.

xref:docs:cli:reference/pcl-list-subscriptions.adoc[*list-subscriptions*]::
  Get list of subscriptions available to user.

xref:docs:cli:reference/pcl-list-namespaces.adoc[*list-namespaces*]::
  List namespaces available in a subscription.

xref:docs:cli:reference/pcl-list-applications.adoc[*list-applications*]::
  List applications present in a namespace.

xref:docs:cli:reference/pcl-upload.adoc[*upload*]::
  Upload application binary

xref:docs:cli:reference/pcl-deploy.adoc[*deploy*]::
  Deploy an existing application.

xref:docs:cli:reference/pcl-start.adoc[*start*]::
  Start an application

xref:docs:cli:reference/pcl-stop.adoc[*stop*]::
  Stop an application

xref:docs:cli:reference/pcl-create-namespace.adoc[*create-namespace*]::
  Create new namespace

xref:docs:cli:reference/pcl-delete-namespace.adoc[*delete-namespace*]::
  Deletes a namespace.

xref:docs:cli:reference/pcl-delete-application.adoc[*delete-application*]::
  Delete an application.

xref:docs:cli:reference/pcl-configure.adoc[*configure*]::
